...
public class _DashboardMainChartComponentPartial : ViewComponent
{
    ...
    public async Task<IViewComponentResult> InvokeAsync()
    {
        ...
        var statsRes = await client.GetAsync("api/Reservations/GetReservationStats");
        ...
        var sumRes = await client.GetAsync("api/Reservations/GetReservationSummaryLast4Months");
