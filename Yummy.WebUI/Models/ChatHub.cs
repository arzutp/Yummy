...
public class ChatHub : Hub
{
    ...
    private const string modelGpt = "gpt-5.1";
    ...
    public async Task SendMessage(string userMessage)
    {
        ...
        await StreamOpenApi(history, Context.ConnectionAborted);
    }

    public async Task StreamOpenApi(List<Dictionary<string, string>> history, CancellationToken cancellationToken)
    {
    ...
    #region Stream Parse Modelleri
    public sealed class ChatStreamChunk
    {
        [JsonPropertyName("choices")]
        public List<ChatHub.Choice> Choices { get; set; }
    }
